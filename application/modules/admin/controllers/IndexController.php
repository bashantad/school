...
class Admin_IndexController extends Zend_Controller_Action
{
	...
	public function listAction() {
        ...
        $editColumn->setPosition('right')->setName('Edit')->setDecorator("<a href=\"/menu/edit/id/{{front_menu_id}}\">Edit</a><input class=\"address-id\" name=\"address_id[]\" type=\"hidden\" value=\"{{front_menu_id}}\"/>");
        $deleteColumn = new Bvb_Grid_Extra_Column();
        $deleteColumn->setPosition('right')->setName('Delete')->setDecorator("<a class=\"delete-data\" href=\"/menu/delete/id/{{front_menu_id}}\">Delete</a>");
